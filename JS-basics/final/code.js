...
var Johnaverage= (John[0]+John[1]+John[2])/3;
var Mikeaverage= (Mike[0]+Mike[1]+Mike[2])/3;

console.log("John average score is: " + " " +Johnaverage);
console.log("Mike average score is: " + " " +Mikeaverage);

if( Johnaverage>Mikeaverage)
{
    console.log("John team wins the match "+ "" + Johnaverage);
}

else if (Johnaverage<Mikeaverage)
{
    console.log("Mike team wins the match "+ "" + Mikeaverage);
}

else
{
    console.log("there is draw b/w both the teams");
}
